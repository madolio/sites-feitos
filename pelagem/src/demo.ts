// O Estúdio Pelagem não existe: em vez de abrir o WhatsApp de um número
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito do Estúdio Pelagem e quero um site assim pro meu negócio.')
