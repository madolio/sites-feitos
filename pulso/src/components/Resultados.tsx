  ...
  return (
    <section id="resultados" className="scroll-mt-16 border-t-4 border-track bg-track py-20 text-chalk md:py-28 lg:pl-16">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <Reveal className="mt-14 grid gap-10 border-y-2 border-chalk/20 py-10 sm:grid-cols-3" stagger={0.08}>
          {resultados.map((r) => (
            <div key={r.label}>
        ...
        <Reveal className="mt-14 grid gap-8 sm:grid-cols-3" stagger={0.08}>
          {depoimentos.map((d) => (
            <div key={d.author}>
