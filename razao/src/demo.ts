// A Razão Contábil não existe: em vez de abrir o WhatsApp de um número
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito da Razão Contábil e quero um site assim pro meu negócio.')
