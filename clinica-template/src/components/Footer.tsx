    ...
    <footer className="on-dark bg-ink text-bone/80">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-12 lg:px-8">
        ...
        <nav aria-label="Rodapé" className="md:col-span-3">
          <p className="text-xs font-semibold tracking-[0.18em] text-clay-light uppercase">Navegação</p>
        ...
        <div className="text-sm md:col-span-4">
          <p className="text-xs font-semibold tracking-[0.18em] text-clay-light uppercase">Contato</p>
      ...
      <div className="border-t border-bone/10">
        <p className="mx-auto max-w-6xl px-5 py-5 text-xs text-bone/60 lg:px-8">
          © {new Date().getFullYear()} {site.name}. Site-modelo com conteúdo fictício, feito como template de projeto.
        </p>
      </div>
    </footer>
  )
