...
export default function DemoDialog() {
  ...
  return (
    <dialog
      ...
      className="m-auto w-[min(32rem,calc(100%-1.5rem))] rounded-xl border border-line bg-card p-0 text-ink backdrop:bg-ink/40"
      onClick={(e) => {
    ...
    >
      <div className="p-6 sm:p-8">
        ...
        <pre className="mt-5 rounded-lg border border-line bg-canvas p-4 font-mono text-[0.85rem] leading-relaxed whitespace-pre-wrap">
          {message}
        </pre>
        <p className="mt-5 text-sm text-ink/65">
          Num site de verdade, esse botão abriria o WhatsApp da Rota com a
          mensagem acima já escrita. A Rota é um software fictício — este
