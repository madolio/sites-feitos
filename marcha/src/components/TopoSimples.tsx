export function TopoSimples() {
  return (
    <header className="absolute inset-x-0 top-0 z-20 flex items-center justify-between bg-gradient-to-b from-preto/90 via-preto/65 to-transparent px-6 pt-5 pb-10">
