...
export default function Onde() {
  return (
    <section id="onde" className="bg-cinza py-20 md:py-28">
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-12 sm:grid-cols-2">
          <div className="revelar">
            <p className="rotulo text-dourado-escuro">Onde estamos</p>
          ...
          <div className="revelar">
            ...
            <dl>
              {expediente.map((e) => (
                <div
                  key={e.dia}
                  className="flex items-baseline justify-between gap-4 border-b border-preto/10 py-3.5 last:border-b-0"
                >
                  <dt>{e.dia}</dt>
                  <dd className={e.aberto ? 'tabular text-dourado-escuro' : 'text-grafite'}>{e.hora}</dd>
                </div>
              ))}
            </dl>
