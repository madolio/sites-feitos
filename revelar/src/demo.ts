// O Revelar não existe: em vez de abrir o WhatsApp de um número qualquer
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito do Revelar e quero um site assim pro meu negócio.')
