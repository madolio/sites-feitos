...
Documentação da estrutura do monorepo `sites-feitos` para produzir sites de clientes a partir de templates.
...
Bases atuais para novos sites: **[`../clinica-template/`](../clinica-template/)** (saúde), **[`../restaurante-template/`](../restaurante-template/)** (restaurantes), **[`../academia-template/`](../academia-template/)** (academias) e **[`../sebo-template/`](../sebo-template/)** (sebos e livrarias de usados).
