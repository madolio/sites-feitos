    ...
    <section id="docinhos" className="scroll-mt-24 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <Reveal
          ...
          y={30}
          stagger={0.08}
          className="mt-14 grid grid-cols-2 gap-x-6 gap-y-12 md:grid-cols-3 md:gap-x-10"
        >
          {docinhos.map((d) => (
            <li key={d.kind} className="group">
              <Docinho
                kind={d.kind}
                className="mx-auto h-auto w-full max-w-[11rem] drop-shadow-[0_10px_14px_rgba(51,25,15,0.12)] transition-transform duration-500 ease-out group-hover:-translate-y-1 group-hover:rotate-[18deg] motion-reduce:transition-none"
              />
