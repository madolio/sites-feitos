...
export default function Faq() {
  ...
  return (
    <section id="faq" className="border-b border-linha bg-papel-forte/60 py-20">
      <div className="mx-auto max-w-3xl px-6 sm:px-8">
        <Reveal>
          <p className="dado-vazao text-fluxo">antes de chamar</p>
            ...
            return (
              <div key={item.pergunta}>
                <h3 className="m-0">
                  ...
                  >
                    {item.pergunta}
                    <span aria-hidden="true" className="text-2xl text-fluxo">
                      {abertaAgora ? '−' : '+'}
                    </span>
                  </button>
                </h3>
