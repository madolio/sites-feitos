...
import { hero, reserva } from '../data/conteudo'
import { Rich } from './ui'
...
export default function Hero() {
  return (
    <section id="topo" className="relative isolate flex min-h-[calc(100svh-4rem)] items-end overflow-hidden lg:min-h-[44rem]">
      ...
      <div aria-hidden="true" className="absolute inset-0 -z-10 bg-gradient-to-t from-background via-background/80 to-background/45" />

      <div className="mx-auto w-full max-w-6xl px-5 pt-32 pb-14 lg:px-8 lg:pb-24">
        <p className="eyebrow">{hero.eyebrow}</p>
        <h1 className="mt-5 max-w-3xl text-[2.5rem] leading-[1.05] sm:text-6xl lg:text-7xl">
