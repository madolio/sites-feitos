// A Torque Auto Mecânica não existe: em vez de abrir o WhatsApp de um
...
// de Estufa/Bruma/Fornada/Trilha etc. — ver DemoDialog.tsx.

export const DEMO_EVENT = 'demo-whatsapp'

export const MADOLIO_WHATSAPP =
  'https://wa.me/5511982322989?text=' +
  encodeURIComponent('Olá! Vi o conceito da Torque Auto Mecânica e quero um site assim pro meu negócio.')
