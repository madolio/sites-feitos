...
export const etapas: Etapa[] = [
  {
    ...
    descricao: 'Tiro suas medidas de verdade: não só busto e cintura, mas postura, jeito de sentar, altura de punho. Depois conversamos sobre pra que ocasião a peça vai servir.',
  },
  {
    numero: '02',
  ...
  },
  {
    ...
    descricao: 'Lapela entalhada à mão, casas de botão fechadas por dentro: detalhes que uma confecção em série não faz, porque não compensa em escala.',
  },
  {
    numero: '06',
    titulo: 'Prova final e entrega',
    descricao: 'Última prova pra confirmar caimento com a peça pronta. Entrego com a ficha de medidas guardada, então a próxima encomenda não precisa medir tudo de novo.',
  },
]
