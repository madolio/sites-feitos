// A Meridiana não existe: em vez de abrir o WhatsApp de um número qualquer
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito da Meridiana e quero um site assim pro meu negócio.')
