// "Sticker Peel" do React Bits (reactbits.dev/animations/sticker-peel), usado
// quase como veio. Mudanças: registra o InertiaPlugin (o original passa
// `inertia: true` sem registrar), aceita `alt` e troca `React.FC` pelo tipo de
// função direto. O adesivo pode ser arrastado e descola a ponta no hover/toque.
