// O Torre não existe: em vez de abrir o cliente de e-mail do visitante pra
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito do Torre e quero um site assim pro meu negócio.')
