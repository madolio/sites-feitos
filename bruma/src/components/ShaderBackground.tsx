// ShaderBackground — gerado pelo Shader Builder do 21st.dev ("Silk"),
// adaptado do React/Next.js pro nosso Vite (removido "use client", que não
// existe fora do App Router — o componente já era zero-dependência, então
// o resto veio praticamente intacto). Paleta trocada pra verde-esmeralda
// noturno, combinando com o resto da Bruma.
...
// Paleta verde-esmeralda noturno: quase-preto -> esmeralda profundo ->
// esmeralda médio -> menta clara, repetindo o tom mais claro nas posições
// restantes (o shader só usa até colorCount-1 transições mesmo assim).
const VERDE_ESMERALDA: [number, number, number][] = [
  [0.008, 0.035, 0.027],
  [0.024, 0.086, 0.063],
  [0.055, 0.176, 0.118],
  [0.157, 0.349, 0.251],
