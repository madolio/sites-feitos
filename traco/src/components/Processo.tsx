  ...
  return (
    <section id="processo" className="scroll-mt-16 border-t border-line py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        <Reveal as="h2" className="text-4xl md:text-5xl">Como o projeto acontece</Reveal>

        <Reveal as="ol" stagger={0.08} className="mt-14 grid gap-x-10 gap-y-12 sm:grid-cols-2">
          {processo.map((step, i) => (
