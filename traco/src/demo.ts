// O Traço não existe: em vez de abrir o cliente de e-mail do visitante pra
// um endereço que não recebe nada, o botão mostra o endereço fictício e
...
export const MADOLIO_WHATSAPP =
  ...
  encodeURIComponent('Olá! Vi o conceito do Traço e quero um site assim pro meu negócio.')
