import { EMAIL_HREF, WHATSAPP_URL } from '../config/site'
...
const stats = [
  ...
  { value: 'Direto', label: 'Você fala com a gente, sem intermediário' },
]
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-6 text-lg text-ink/70">
              Do rascunho ao ar: cuidamos do design, do texto e da publicação.
