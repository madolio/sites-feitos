...
export default function Faixa() {
  return (
    <section className="relative overflow-hidden bg-accent py-20 md:py-28">
      <span
        aria-hidden="true"
        className="font-poster pointer-events-none absolute top-1/2 right-0 -translate-y-1/2 translate-x-[18%] text-[13rem] leading-none text-white/10 uppercase select-none sm:text-[20rem]"
      >
        madolio.
      </span>
