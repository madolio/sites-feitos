...
**Escopo desta reestruturação:** só a home, inicialmente. Bastos Advocacia, Torre, Nascente, Âncora, Estúdio Alma, Sabor da Vila, Doce Ateliê e Traço foram todos reestruturados depois — os últimos 5 numa leva só, a pedido do usuário ("faça todos, o que eu não curtir eu falo") — ver o `CLAUDE.md` de cada um. Com isso, nenhum projeto do portfólio continua com o nav genérico original (barra fixa full-width, logo+links+botão).
