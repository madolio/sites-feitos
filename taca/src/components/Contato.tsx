      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-16 border-t border-line pt-6">
          ...
          <p className="mt-3 text-sm text-ink/70">
            feito com <span aria-hidden="true" className="text-garnet">♥</span>
            <span className="sr-only">amor</span> por{' '}
            <a href="https://madolio.com.br" target="_blank" rel="noreferrer" className="underline decoration-ink/50 underline-offset-4">
              madolio
            </a>
          </p>
        </div>
