...
Os quatro últimos são **negócios fictícios** — exemplos de estilo pra mostrar no portfólio (linkados em `madolio/src/pages/Projetos.tsx`), não clientes reais. Cada um tem WhatsApp em modo demonstração (mostra a mensagem que seria enviada, sem apontar pra um número real).
