...
- **[taca/](taca/)** — conceito de vinícola de altitude, 3D: escolher um rótulo na lista serve o vinho na hora, ao vivo, na mesma taça — ela drena, troca de cor e enche de novo (taca.fenoninho-max.workers.dev).
